...
- The Twitter API this week is much more complicated compared to themoviedb API last week
- Customizing the app using "Twitter branded" colors and styles
- Implementing the favorite, retweet and reply features
